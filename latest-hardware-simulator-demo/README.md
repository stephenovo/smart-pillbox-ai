...
The main web app has a disconnected-by-default input adapter. It can consume
either simulator events or uploaded hardware events without changing the
safety and AI algorithms. See `docs/INTEGRATION_MODES.md`.
