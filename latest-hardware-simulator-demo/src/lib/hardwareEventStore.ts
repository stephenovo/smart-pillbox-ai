...
type HardwareStore = {
  ...
  integrationModeUpdatedAt: string;
};
...
function loadPersistedStore(): HardwareStore {
  try {
    ...
    return {
      ...
      integrationMode:
        parsed.integrationMode === "simulator" || parsed.integrationMode === "hardware"
          ? parsed.integrationMode
          : "standalone",
      integrationModeUpdatedAt:
        typeof parsed.integrationModeUpdatedAt === "string"
          ? parsed.integrationModeUpdatedAt
...
function persistStore(): void {
  const serialized: PersistedHardwareStore = {
    ...
    integrationMode: store.integrationMode,
    integrationModeUpdatedAt: store.integrationModeUpdatedAt,
  };
...
export function getIntegrationMode(): {
  ...
  return {
    mode: store.integrationMode,
    updatedAt: store.integrationModeUpdatedAt,
  };
}
...
export function setIntegrationMode(mode: IntegrationMode): {
  ...
  store.integrationMode = mode;
  store.integrationModeUpdatedAt = new Date().toISOString();
  persistStore();
