import type { OpeningEvent, PillboxEventSource } from "./pillbox";

export type IntegrationMode = "standalone" | "simulator" | "hardware";
...
export type IntegrationModeApiResponse = {
  mode: IntegrationMode;
  connected: boolean;
  activeDeviceId: string | null;
  activeSource: PillboxEventSource | null;
  updatedAt: string;
  serverTime: string;
};
